...
### [Video](https://drive.google.com/file/d/17-xfRjcn73fVfsJ5rcQYsCU_uQGMgo_X/view?usp=sharing)

This is a simple prototype of the cooking game I'd like to develop more in the future. In the game, the character make green dumpling step by step. However, I'm thinking about adding more recipes of Suzhou special food in the game to add the difficulty and interesting of the game. I also consider to develop it to a cooking game in the restaurant that there are tons of customers come and order food. The player has to cook the food that the customers exactly want in a certain time to earn money. The game is to develop the interests of children living in Suzhou to the special food in Suzhou and try to make them understand how to cook the food.
